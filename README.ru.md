...
> 🇬🇧 English version: [README.md](README.md) · 🇷🇺 Этот файл — русская версия.
>
> ⚠️ **Pre-1.0.** Lumen в активной разработке. Fast-app API и runtime могут ломаться между версиями. Не для production использования.
...
| Платформа | Статус |
|---|---|
| **iOS** | активная разработка — текущий фокус |
| **macOS** | планируется — общий SwiftUI/UIKit шелл |
| **Android** | в будущем — отдельный нативный runtime |
| **Windows** | в будущем — отдельный нативный runtime |

Это направление, а не обязательство. Текущая кодовая база — только iOS; остальное — открытый вопрос до первого рабочего прототипа на платформе.
